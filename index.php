<html>
<head>
	<title>Patient Management Information System | Imo State Polytechnic Medical Center, Omuma</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp IMO STATE POLYTECHNIC MEDICAL CENTER</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <!-- I REMOVED THE ABOUT US AND CONTACT US PAGE -- 
          <li class="nav-item" style="margin-right: 40px;">
